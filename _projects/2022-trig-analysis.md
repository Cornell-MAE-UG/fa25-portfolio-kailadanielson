...
<img src="{{ '/assets/images/load.png' | relative_url }}" alt="Loads & Boundary Conditions" width="800">

Normal Strain Contours:
<img src="{{ '/assets/images/strain.png' | relative_url }}" alt="Strain" width="800">
<img src="{{ '/assets/images/strain2.png' | relative_url }}" alt="Strain" width="800">
...
Strain Gauge:
For this torque wrench analysis, we would use the Vishay Micro-Measurements CEA-06-125UN-350, which has dimensions of 0.18 in x 0.28 in, with a 0.125 in grid length and a grid width of 0.10-0.12 in, which fits our model. This strain gauge was located an inch away from the center of the drive. 
