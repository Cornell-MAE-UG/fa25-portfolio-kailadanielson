...
Cad Model:
<img src="{{ '/assets/images/mae3270.png' | relative_url }}" alt="CAD Model" width="400">
...
<img src="{{ '/assets/images/load.png' | relative_url }}" alt="Loads & Boundary Conditions" width="400">

Normal Strain Contours:
<img src="{{ '/assets/images/strain.png' | relative_url }}" alt="Strain" width="400">

Principal Stress Contours:
<img src="{{ '/assets/images/principalstress1.png' | relative_url }}" alt="Principal Stress" width="400">
<img src="{{ '/assets/images/principalstress2.png' | relative_url }}" alt="Principal Stress" width="400">
